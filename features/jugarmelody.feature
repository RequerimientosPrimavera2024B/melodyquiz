...
Example: En donde el usuario pierde
...
Example: En donde el usuario gana
...
Example: En donde el usuario no gana ni pierde
...
Example: En donde el usuario gana despues de volver a intentarlo
...
Example: En donde el usuario pierde despues de volver a intentarlo
